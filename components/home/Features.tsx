...
// features 数组是将在手风琴中显示的功能列表。
// - title：功能的标题
// - description：功能的描述（单击时）
// - type：媒体类型（视频或图像）
// - path：媒体路径（为了获得更好的 SEO，请尝试使用本地路径）
// - format：媒体格式（如果类型为“视频”）
// - alt：图像的 alt 文本（如果类型为“图像”）
const features = [
  {
    title: "Emails",
    description:
...
// 用于显示功能的媒体（视频或图像）的组件。如果未指定类型，它将显示一个空的 div。
// 视频设置为自动播放以获得最佳用户体验。
...
// 一个组件，用于以手风琴形式显示 2 到 5 个特征。
// 默认情况下，选择第一个特征。单击一个特征时，其他特征将被关闭。
const Features = () => {
  const [featureSelected, setFeatureSelected] = useState<number>(0);

  return (
    <section
      className="py-24 md:pt-24 space-y-24 md:space-y-32 max-w-7xl mx-auto bg-base-100 "
      id="features"
    >
      <div className="px-8">
        <h2 className="font-extrabold text-3xl lg:text-4xl tracking-tight mb-12 md:mb-20">
